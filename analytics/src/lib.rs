    ...
    fn fuzz_submit_snapshot() {
        bolero::check!()
            ...
            .for_each(|input| {
                ...
                let _ = client.try_submit_snapshot(&input.epoch, &hash);
            });
    }
    ...
    fn fuzz_get_snapshot() {
        bolero::check!()
            ...
            .for_each(|epoch| {
                ...
                let _ = client.try_submit_snapshot(&1u64, &hash);
        ...
        bolero::check!()
            ...
            .for_each(|hash_bytes| {
                ...
                for epoch in &epochs {
                    ...
                    let result = client.try_submit_snapshot(epoch, &hash);
                    assert!(
                        result.is_ok(),
    ...
    fn fuzz_monotonicity_invariant() {
        bolero::check!()
            ...
            .for_each(|input| {
                ...
                let first = client.try_submit_snapshot(&input.epoch_a, &hash_a);
                assert!(
                    first.is_ok(),
                ...
                let second = client.try_submit_snapshot(&input.epoch_b, &hash_b);
                assert!(
                    second.is_err(),
